...
//   "var _x: " , "var _y: " , width, height

context.fillRect = {position: ("var _x: " , "var _y: " , width, height)};

const position = context.fillRect(0, 0, width, height);

ctx.fillRect(0, 0, format.width, format.height)

// ctx.fillRect(format.x, format.y, format.width, format.height)
